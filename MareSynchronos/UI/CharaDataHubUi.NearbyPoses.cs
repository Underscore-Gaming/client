...
internal partial class CharaDataHubUi
{
    private void DrawNearbyPoses()
    {
        ...
        UiSharedService.DrawTree("Settings & Filters", () =>
        {
            ...
            _uiSharedService.DrawHelpText("When enabled, Unsung Sync will draw floating wisps where other's poses are in the world.");
            ...
            _uiSharedService.DrawHelpText("This will allow Unsung Sync to continue the calculation of position of wisps etc. active outside of the 'Poses Nearby' tab." + UiSharedService.TooltipSeparator
